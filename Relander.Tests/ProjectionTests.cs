...
public class ProjectionTests
{
    ...
    public void ShipZDepth_ProjectsShipVerticesCorrectly()
    {
        ...
        int z = Relander.Core.Math.FixedPoint.LANDSCAPE_Z_MID;
    ...
    public void LandscapeBackRow_ProjectsCorrectly()
    {
        ...
        int z = Relander.Core.Math.FixedPoint.LANDSCAPE_Z;
        int halfWidth = Relander.Core.Math.FixedPoint.LANDSCAPE_X;
