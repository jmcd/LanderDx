...
public class PlayerOrientationTests
{
    ...
    public void ShipVertices_ProjectToScreen()
    {
        ...
        int DotY(LanderDx.Core.Data.Vector3Int v) => (int)(((long)v.X * state.YNoseV + (long)v.Y * state.YRoofV + (long)v.Z * state.YSideV) >> 31);
        int DotX(LanderDx.Core.Data.Vector3Int v) => (int)(((long)v.X * state.XNoseV + (long)v.Y * state.XRoofV + (long)v.Z * state.XSideV) >> 31);
        int DotZ(LanderDx.Core.Data.Vector3Int v) => (int)(((long)v.X * state.ZNoseV + (long)v.Y * state.ZRoofV + (long)v.Z * state.ZSideV) >> 31);
