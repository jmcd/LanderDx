...
public class GameEngineIntegrationTests
{
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(12345);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(42);
        var screen = new TestScreen();
        var input = new TestInput();
        var engine = new GameEngine(random, screen);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(99);
        var screen = new TestScreen();
        var input = new TestInput();
        var engine = new GameEngine(random, screen);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(1);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(7);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
    ...
    public void Engine_ThrustAboveAltitudeCeiling_CutsEnginesAndExhaust()
    {
        ...
        var random = new LanderDx.Core.Engine.RandomGenerator(31);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
        engine.StartNewGame();
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(3);
        var screen = new TestScreen();
    ...
    public void Engine_ZeroFuel_PreventsFiring()
    {
        ...
        var random = new LanderDx.Core.Engine.RandomGenerator(32);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
        engine.StartNewGame();
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(5);
        var screen = new TestScreen();
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(13);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(17);
        var screen = new TestScreen();
        var input = new TestInput();
        var engine = new GameEngine(random, screen);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(23);
        var screen = new TestScreen();
        var input = new TestInput();
        var engine = new GameEngine(random, screen);
    ...
    {
        var random = new LanderDx.Core.Engine.RandomGenerator(29);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
    ...
    public void GameOver_ShowsMessageAndWaitsForKey()
    {
        ...
        var random = new LanderDx.Core.Engine.RandomGenerator(37);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
        engine.StartNewGame();
    ...
    public void TitleLine_IsOnTextRow0()
    {
        ...
        // row 0.
        var random = new LanderDx.Core.Engine.RandomGenerator(36);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
        engine.StartNewGame();
        engine.Update(new TestInput());
    ...
    public void FuelBar_IsAtTopOfPlayArea_InRomColour()
    {
        ...
        // the HUD.
        var random = new LanderDx.Core.Engine.RandomGenerator(35);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
        engine.StartNewGame();
        engine.Update(new TestInput());
    ...
    public void CrashAnimation_KeepsScoreBarVisible()
    {
        ...
        var random = new LanderDx.Core.Engine.RandomGenerator(34);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
        engine.StartNewGame();
    ...
    public void NewGame_InvalidatesMinimapCache()
    {
        ...
        var random = new LanderDx.Core.Engine.RandomGenerator(33);
        var screen = new TestScreen();
        var engine = new GameEngine(random, screen);
